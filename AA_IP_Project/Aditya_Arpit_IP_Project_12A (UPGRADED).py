        ...
        if ch == 1:
            ...
            if prc > 6:
                ...
                for i in range(prc):
                    ...
                    def main():
                        product_ids = ["CB1", "CB2", "VV1","NF1","YB1","CB3"]
                        eid = input('𝙀𝙣𝙩𝙚𝙧 𝙋𝙧𝙤𝙙𝙪𝙘𝙩𝙨 𝙄𝘿: ').upper()
                        eidl=eid.lower()
                        if eidl in [pid.lower() for pid in product_ids]:
                            pass
                        else:
                            print("𝘗𝘭𝘦𝘢𝘴𝘦 𝘦𝘯𝘵𝘦𝘳 𝘢 𝘷𝘢𝘭𝘪𝘥 𝘱𝘳𝘰𝘥𝘶𝘤𝘵 𝘐𝘋.")

                    if __name__ == "__main__":
                        main()
                        is_valid_id = main()
                        if is_valid_id:
                            print("𝘌𝘯𝘵𝘦𝘳𝘦𝘥 𝘱𝘳𝘰𝘥𝘶𝘤𝘵 𝘐𝘋 𝘪𝘴 𝘷𝘢𝘭𝘪𝘥.")
                        else:
                            print("𝘐𝘯𝘷𝘢𝘭𝘪𝘥 𝘱𝘳𝘰𝘥𝘶𝘤𝘵 𝘐𝘋.")
                    eid = input('𝙀𝙣𝙩𝙚𝙧 𝙋𝙧𝙤𝙙𝙪𝙘𝙩𝙨 𝙄𝘿: ').upper()
                    itemls.append(eid)
